...
class DataTransformation:
    ...
    def get_data_tranformer_object(self):
        ...
        try:
            ...
            num_pipeline = Pipeline(       #this pipeline will handle all the numerical columns
                steps=[
                    ("imputer",SimpleImputer(strategy="median")),   #handles the missing values
                    ("scaler",StandardScaler())                       #to scale all the values
                ]
            )
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            # np.c_ is a handy shortcut used to concatenate (stack) arrays side-by-side, along their second axis
